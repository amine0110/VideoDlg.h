...
public:
	...
	static LPVOID CALLBACK rotation(HWND hWndC, LPVIDEOHDR pV);
	static LPVOID CALLBACK flou(HWND hWndC, LPVIDEOHDR pV);
	static LPVOID CALLBACK rot(HWND hWndC, LPVIDEOHDR pV);
